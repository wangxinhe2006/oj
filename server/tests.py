...
class ProductTestCase(unittest.TestCase):
    def test_CE(self):
        self.assertEqual(test('', [], 0, True), 'CE')

    def test_AC(self):
        self.assertEqual(test('#include <cstdio>\nint main() {\n    int a, b;\n    scanf("%d %d", &a, &b);\n    printf("%d", a / b);\n    return 0;\n}\n', [('1 1', '1')])[0], ['AC'])
    ...
    def test_server(self):
        ...
        # time.sleep(.1)
        self.assertEqual(xmlrpc.client.ServerProxy('http://127.0.0.1:' + str(PORT)).test('#include <cstdio>\nint main() {\n    int a, b;\n    scanf("%d %d", &a, &b);\n    printf("%d", a / b);\n    return 0;\n}\n', [('1 1', '1')])[0], ['AC'])
